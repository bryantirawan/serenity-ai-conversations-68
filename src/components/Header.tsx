...
const Header = () => {
  ...
  return (
    <header className="w-full py-4 px-4 md:px-8 flex items-center justify-between bg-white/90 backdrop-blur-sm border-b border-border sticky top-0 z-50">
      <Logo />
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        {isAuthenticated ? (
          ...
          <div className="flex items-center gap-3">
            <Button 
              variant="ghost" 
              className="text-foreground hover:text-skyhug-500 hover:bg-skyhug-50"
            ...
            <Button 
              variant="default" 
              className="bg-skyhug-500 hover:bg-skyhug-600 text-white rounded-full"
            ...
            <div className="flex flex-col gap-6 pt-10">
              ...
              {isAuthenticated ? (
                ...
                <div className="flex flex-col gap-3 pt-4 border-t">
                  ...
                  <Button 
                    variant="default" 
                    className="w-full justify-start bg-skyhug-500 hover:bg-skyhug-600"
                    onClick={() => navigate('/signup')}
                  >
                    <UserPlus className="mr-2 h-4 w-4" />
                    Sign Up
